...
#renvoie les mouvements a faire a l'utilisateur
    ...
    def setOutput(self):
        ...
        #JEAN self.output = resolutionFinale("B2 F2 U2 D' R2 L' F L' U' B L U2 F' U' L' U' L U B R' B' L U2 D2 L2")
        #QUENTIN self.output = resolutionFinale("L B F2 L F B U' L D F' D' R F U D R B2 R F2 R' L F2 R2 B2 L'")
        #QUENTIN self.output = resolutionFinale("U' L' R' D' L R U2 L2 R' B U L' D2 B' L' D2 L2 R' B' D' B' R L' U D")
        self.output = resolutionFinale("D2 L U D F2 U B2 D' U2 F U R D' B L F' U' D R2 L D2 F2 R2 F2 R'")
        #JEAN self.output = resolutionFinale("U' D2 F' B' U' L2 F2 D' F' B2 L' F2 B' U F U F' B' D B2 R D2 B D' R'")
        #JEAN self.output = resolutionFinale("B U' B' R' D U2 F R L F' D2 F R2 U' R2 F2 D B L2 U2 R D B2 D' B'")
        #JEAN self.output = resolutionFinale("B2 F D B' L F L B' R U F' B D2 L' F2 B2 U R2 L F B2 L2 U2 R' U'")
        #QUENTIN self.output = resolutionFinale("D U F R B2 L2 B2 U B L2 D R U' D2 R B2 R' L D' F' R' F' D2 R L2")
        print(self.output)
